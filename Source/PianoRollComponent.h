...
{
public:
    explicit PianoRollComponent(BoomAudioProcessor& p) : processor(p), pattern() {}
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        for (auto& n : pattern)
        {
            ...
            g.fillRoundedRectangle(juce::Rectangle<float>(col * cellW + 2, row * cellH + 2, cellW * (float)juce::jmax(1, n.lengthTicks / 24) - 4, cellH - 4), 4.f);
        }
    }
