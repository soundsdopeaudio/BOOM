      ...
      rollsBtn("ROLLS"), aiBtn("A.I. TOOLS"), bumpBtn("BUMPPIT"), flipBtn("FLIPPIT")
{
    ...
    rollsBtn.onClick = [this]
    {
        ...
        modal.reset(new juce::DialogWindow("ROLLS", juce::Colours::black, true));
        modal->setResizable(true, true);
        modal->setContentOwned(rolls.release(), true);
        modal->centreWithSize(modal->getWidth(), modal->getHeight());
    ...
    bumpBtn.onClick = [this]
    {
        ...
        modal.reset(new juce::DialogWindow("BUMPPIT", juce::Colours::black, true));
        modal->setResizable(false, false);
        modal->setContentOwned(bumppit.release(), true);
        modal->centreWithSize(modal->getWidth(), modal->getHeight());
        modal->setVisible(true);
    };
    ...
    flipBtn.onClick = [this]
    {
        ...
        modal.reset(new juce::DialogWindow("FLIPPIT", juce::Colours::black, true));
        modal->setResizable(false, false);
        modal->setContentOwned(flippit.release(), true);
        modal->centreWithSize(modal->getWidth(), modal->getHeight());
        modal->setVisible(true);
    };
    ...
    aiBtn.onClick = [this]
    {
        ...
        modal.reset(new juce::DialogWindow("A.I. TOOLS", juce::Colours::black, true));
        modal->setResizable(true, true);
        modal->setContentOwned(aiTools.release(), true);
        modal->centreWithSize(modal->getWidth(), modal->getHeight());
        modal->setVisible(true);
    };
