...
public:
    ...
    , styleBlendKnob(juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight)
    , rhythmimickPosition(juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight)
    , beatboxPosition(juce::Slider::LinearHorizontal, juce::Slider::TextBoxRight)
    , listener(nullptr)
    {
