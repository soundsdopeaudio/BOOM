...
public:
    ...
    explicit AIToolsComponent(boom::Engine initialEngine)
        : currentEngine(initialEngine),
          rhythmimickPosition(juce::Slider::SliderStyle::LinearHorizontal, juce::Slider::TextEntryBoxPosition::TextBoxRight),
          styleBlendKnob(juce::Slider::SliderStyle::LinearHorizontal, juce::Slider::TextEntryBoxPosition::TextBoxRight),
          beatboxPosition(juce::Slider::SliderStyle::LinearHorizontal, juce::Slider::TextEntryBoxPosition::TextBoxRight),
          listener(nullptr)
    {
        // Engine selector (applies to all AI tools)
        engineBox.addItemList(boom::getEngineChoices(), 1); engineBox.setSelectedId((int)initialEngine + 1);
        ...
        // Style Blender
        addAndMakeVisible(styleABox); styleABox.addItemList(boom::getStyleChoices(), 1); styleABox.setSelectedId(1);
        addAndMakeVisible(styleBBox); styleBBox.addItemList(boom::getStyleChoices(), 1); styleBBox.setSelectedId(2);
...
private:
    ...
    juce::Slider rhythmimickPosition;
